...
@WebServlet(name = "RestaurantModifyServlet", value = "/RestaurantModifyServlet")
public class RestaurantModifyServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String cover = "restaurant/"+request.getParameter("cover");
