        ...
        if (userRole.equals("restaurantAdmin") &&
                !(
                        requestURI.endsWith("/restaurantAdminHome.jsp") ||
                                ...
                                requestURI.endsWith("/evaluateList.jsp")||
                                requestURI.endsWith("/evaluateDetail.jsp")
                )) {
            httpResponse.sendRedirect(httpRequest.getContextPath() + "/home.jsp");
            return;
        }
                ...
                !(
                        requestURI.endsWith("/userHome.jsp") ||
                                ...
                                requestURI.endsWith("/dishDetail.jsp")||
                                requestURI.endsWith("/messageDetail.jsp")||
                                requestURI.endsWith("/messageList.jsp")
                )) {
            httpResponse.sendRedirect(httpRequest.getContextPath() + "/home.jsp");
            return;
