...
<div id="header">
    ...
    <div style="position: absolute; top: 20px; right: 30px;">
        <img src="images/xinxiang.jpg" style="position: relative;" onclick="redirectToEvaluateList()">
...
<div id="buttons">
    ...
    <input type="submit" value="食堂评价处理" style="background-color: #faca0d;width:150px;height:100px;font-size: 20px;border: none" onclick="window.location.href='evaluateList.jsp'">
